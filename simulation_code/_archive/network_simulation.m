classdef network_simulation
    ...
    properties (Constant)
        ...
        functionFolder = char(fileparts(mfilename('fullpath')));
    end
    ...
    properties (Access = private)
        ...
        correlationFunction = fullfile(network_simulation.functionFolder,'compute_correlation_matrix.exe');
    ...
    methods
        ...
        % Places synapses such that correlated synapses are placed in dendrite segments with similar directions relative to the soma
            ...
            load(fullfile(network_simulation.resourceFolder,'cortical_column_Hagen','segment_areas.mat'))
            mTypes = unique(obj.neuronTypes);
